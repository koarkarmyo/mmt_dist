...
class DeliveryItemPage extends StatefulWidget {
  const DeliveryItemPage({super.key});

  @override
  State<DeliveryItemPage> createState() => _DeliveryItemPageState();
}

class _DeliveryItemPageState extends State<DeliveryItemPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: TextWidget(ConstString.deliveryItem),
      ),
      body: Column(
        ...
        if (index == -1) {
          ...
          return Slidable(
            ...
            child: ListTile(
              ...
              subtitle: const Text("K 10000, 23 Kg"),
              trailing: Row(
