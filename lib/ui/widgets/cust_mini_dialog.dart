          ...
          child: Wrap(
            ...
            children: [
              Chip(
                  ...
                  label: Text(
                    'Total Ordered : ${(selectedCustomer.totalOrdered ?? 0).toPrice()}',
              ...
              Chip(
                  side: const BorderSide(color: Colors.transparent),
                  label: Text(
                      'Total Invoiced : ${(selectedCustomer.totalInvoiced ?? 0).toPrice()}',
                      style: const TextStyle(fontSize: 12)),
                  backgroundColor: AppColors.successColor),
              Chip(
                  side: const BorderSide(color: Colors.transparent),
                  label: Text(
                      'Total Due : ${(selectedCustomer.totalDue ?? 0).toPrice()}',
                      style: const TextStyle(fontSize: 12)),
