...
class CustDialog extends SimpleDialog {
  ...
  static SimpleDialog createDialog(
      BuildContext context, Partner selectedCustomer,
        ...
        Padding(
          ...
          child: Wrap(
            ...
            children: [
              Chip(
                  label: Text(
                      'Total Ordered : ${(selectedCustomer.totalOrdered ?? 0).toPrice()}',style: const TextStyle(fontSize: 10),),
                  backgroundColor: AppColors.infoColor),
              Chip(
                  label: Text(
                      'Total Invoiced : ${(selectedCustomer.totalInvoiced ?? 0).toPrice()}',style: const TextStyle(fontSize: 10)),
                  backgroundColor: AppColors.successColor),

              Chip(
                  label: Text(
                      'Total Due : ${(selectedCustomer.totalDue ?? 0).toPrice()}',style: const TextStyle(fontSize: 10)),
