...
class SecondaryCouponItemPage extends StatefulWidget {
  const SecondaryCouponItemPage({super.key});

  @override
  State<SecondaryCouponItemPage> createState() => _SecondaryCouponItemPageState();
}

class _SecondaryCouponItemPageState extends State<SecondaryCouponItemPage> {
