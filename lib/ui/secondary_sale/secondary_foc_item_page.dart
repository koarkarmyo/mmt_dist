...
class SecondaryFocItemPage extends StatefulWidget {
  final ResPartner? customer;

  const SecondaryFocItemPage({super.key, this.customer});

  @override
  State<SecondaryFocItemPage> createState() => _SecondaryFocItemPageState();
}

class _SecondaryFocItemPageState extends State<SecondaryFocItemPage> {
