...
class SecondarySKUProductPage extends StatefulWidget {
  final SecondarySaleOrder? saleOrder;
  final ResPartner? customer;

  const SecondarySKUProductPage({super.key, this.customer, this.saleOrder});

  @override
  State<SecondarySKUProductPage> createState() => _SecondarySKUProductPageState();
}

class _SecondarySKUProductPageState extends State<SecondarySKUProductPage> {
