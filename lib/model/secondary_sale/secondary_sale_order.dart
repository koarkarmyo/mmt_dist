...
class SecondarySaleOrder {
  ...
  SecondarySaleOrder.fromJsonDB(Map<String, dynamic> map) {
    name = map['name'];
  ...
  factory SecondarySaleOrder.fromJson(Map<String, dynamic> map) {
