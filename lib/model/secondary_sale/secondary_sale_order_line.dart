...
class SecondarySaleOrderLine {
  ...
  Map<String, dynamic> toJsonDB() {
    ...
    // data[DBConstant.productUom] = productUom;
    // data[DBConstant.productUomId] = productUom;
    if(uomLine != null){
      data['product_uom'] = uomLine?.uomId;
      data['product_uom_name'] = uomLine?.uomName;
    } else {
      data['product_uom'] = productUom;
      data['product_uom_name'] = productUomName;
    }
    // data[DBConstant.productUomName] = productUomName;
  ...
  double get total {
    debugPrint('ffffffffffff$pkQty');
    debugPrint('ffffffffffff$singlePKPrice');
    return (pkQty ?? 0) * (singlePKPrice ?? 0);
}
}
